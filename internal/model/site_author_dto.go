...
type SiteAuthorFullDTO struct {
	...
	// 关联的本地作者
	LocalAuthor *LocalAuthor `json:"localAuthor,omitempty"`
	// 来源站点
	Site *Site `json:"site,omitempty"`
}

// NewSiteAuthorFullDTO 创建站点作者完整DTO
func NewSiteAuthorFullDTO(siteAuthor *SiteAuthor) *SiteAuthorFullDTO {
	if siteAuthor == nil {
		return nil
	}
...
func NewSiteAuthorLocalRelateDTO(siteAuthor *SiteAuthor) *SiteAuthorLocalRelateDTO {
	if siteAuthor == nil {
		return nil
	}
