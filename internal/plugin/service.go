...
type PluginQueryDTO struct {
	...
	Name           query.QueryAttribute[string] `json:"name" query:"name"`                      // 插件名称（精确匹配）
	Author         query.QueryAttribute[string] `json:"author" query:"author"`                  // 作者（精确匹配）
	...
	NameStr        query.QueryAttribute[string] `json:"nameStr" query:"name"`                   // 插件名称（模糊匹配）
	AuthorStr      query.QueryAttribute[string] `json:"authorStr" query:"author"`               // 作者（模糊匹配）
