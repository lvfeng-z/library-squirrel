...
type Registrar interface {
	...
	RegisterSlot(id string, name string, description string, slotType pkg.SlotType, content string, contentType pkg.ContentType, title string, icon string, order int) error
}
...
// RegisterSlot 注册插槽扩展点
func (r *registrar) RegisterSlot(id string, name string, description string, slotType pkg.SlotType, content string, contentType pkg.ContentType, title string, icon string, order int) error {
