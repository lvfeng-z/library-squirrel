...
export function CreateTask(req: dto$0.CreateTaskRequest | null): $CancellablePromise<model$0.ApiResponse<number> | null> {
    return $Call.ByID(2208126408, req).then(($result: any) => {
...
export function CreateTaskByURL(url: string): $CancellablePromise<model$0.ApiResponse<$models.CreateTaskByURLResponse | null> | null> {
    return $Call.ByID(1759383870, url).then(($result: any) => {
...
export function DeleteTask(ids: number[]): $CancellablePromise<model$0.ApiResponse<any> | null> {
    return $Call.ByID(2261626531, ids).then(($result: any) => {
...
export function GetById(id: number): $CancellablePromise<model$0.ApiResponse<dto$0.TaskDTO | null> | null> {
    return $Call.ByID(1669387003, id).then(($result: any) => {
...
export function ListChildrenTask(pid: number): $CancellablePromise<model$0.ApiResponse<(dto$0.TaskDTO | null)[]> | null> {
    return $Call.ByID(4110290399, pid).then(($result: any) => {
...
export function ListSchedule(ids: number[]): $CancellablePromise<model$0.ApiResponse<(dto$0.TaskProgressDTO | null)[]> | null> {
    return $Call.ByID(2752122444, ids).then(($result: any) => {
...
export function ListStatus(ids: number[]): $CancellablePromise<model$0.ApiResponse<(dto$0.TaskProgressDTO | null)[]> | null> {
    return $Call.ByID(3357274735, ids).then(($result: any) => {
        return $$createType19($result);
    });
}
...
export function ListTaskTree(taskIds: number[], ...includeStatus: number[]): $CancellablePromise<model$0.ApiResponse<(dto$0.TaskDTO | null)[]> | null> {
    return $Call.ByID(4029780124, taskIds, includeStatus).then(($result: any) => {
        return $$createType14($result);
    });
}
...
export function QueryChildrenTaskPage(page: model$0.Page<dto$0.TaskProgressTreeDTO> | null, query: $models.TaskQueryDTO): $CancellablePromise<model$0.ApiResponse<model$0.Page<dto$0.TaskProgressTreeDTO> | null> | null> {
    return $Call.ByID(1121176926, page, query).then(($result: any) => {
...
export function QueryPage(page: model$0.Page<dto$0.TaskDTO> | null, query: $models.TaskQueryDTO): $CancellablePromise<model$0.ApiResponse<model$0.Page<dto$0.TaskDTO> | null> | null> {
    return $Call.ByID(1959005172, page, query).then(($result: any) => {
...
export function QueryParentPage(page: model$0.Page<dto$0.TaskProgressTreeDTO> | null, query: $models.TaskQueryDTO): $CancellablePromise<model$0.ApiResponse<model$0.Page<dto$0.TaskProgressTreeDTO> | null> | null> {
    return $Call.ByID(17884868, page, query).then(($result: any) => {
        return $$createType24($result);
    });
}
...
export function QueryTreeDataPage(page: model$0.Page<dto$0.TaskDTO> | null, query: $models.TaskQueryDTO): $CancellablePromise<model$0.ApiResponse<dto$0.TreeDataPageDTO | null> | null> {
    return $Call.ByID(1523034704, page, query).then(($result: any) => {
...
export function RefreshStatus(taskId: number): $CancellablePromise<model$0.ApiResponse<number> | null> {
    return $Call.ByID(2761687050, taskId).then(($result: any) => {
        return $$createType1($result);
    });
}
...
export function Save(task: dto$0.TaskDTO | null): $CancellablePromise<model$0.ApiResponse<number> | null> {
    return $Call.ByID(1295839020, task).then(($result: any) => {
        return $$createType1($result);
    });
}
...
export function SetTreeStatus(taskIds: number[], status: number, includeStatus: number[]): $CancellablePromise<model$0.ApiResponse<number> | null> {
    return $Call.ByID(591595621, taskIds, status, includeStatus).then(($result: any) => {
        return $$createType1($result);
    });
}
...
export function Update(task: dto$0.TaskDTO | null): $CancellablePromise<model$0.ApiResponse<any> | null> {
    return $Call.ByID(3530071864, task).then(($result: any) => {
        return $$createType7($result);
    });
}
