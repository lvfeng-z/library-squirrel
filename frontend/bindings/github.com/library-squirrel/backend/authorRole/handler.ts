 ...
 */
export function List(): $CancellablePromise<model$0.ApiResponse<(entity$0.AuthorRole | null)[]> | null> {
    return $Call.ByID(3577254850).then(($result: any) => {
        return $$createType4($result);
    });
}

// Private type creation functions
const $$createType0 = entity$0.AuthorRole.createFrom;
