 ...
 */
export function GetById(id: number): $CancellablePromise<model$0.ApiResponse<dto$0.LocalAuthorFullDTO | null> | null> {
 ...
 */
export function QueryPage(page: model$0.Page<dto$0.LocalAuthorFullDTO> | null, query: $models.LocalAuthorQueryDTO): $CancellablePromise<model$0.ApiResponse<model$0.Page<dto$0.LocalAuthorFullDTO> | null> | null> {
 ...
 * Save 保存作者
 */
export function Save(author: dto$1.LocalAuthorDTO | null): $CancellablePromise<model$0.ApiResponse<number> | null> {
 ...
 * Update 更新作者
 */
export function Update(author: dto$1.LocalAuthorDTO | null): $CancellablePromise<model$0.ApiResponse<any> | null> {
...
const $$createType2 = dto$0.LocalAuthorFullDTO.createFrom;
