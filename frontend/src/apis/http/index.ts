...
export * as reWorkAuthorApi from './wrappers/reWorkAuthor'
export * as tagNamespaceApi from './wrappers/tagNamespace'
export * as authorRoleApi from './wrappers/authorRole'
...
export * as stickyMemoryApi from './wrappers/stickyMemory'
