...
55. 新增标签评分功能，不是给标签本身评分，而是给作品与标签的关联评分，表达的是用户对这个作品在此标签方面的满意程度的评价，比如同样带有“像素”这个标签，作品A的像素风格比B更受用户喜欢，用户对其A的“像素”标签的评价就会高于B，或许也可以看作标签的契合度，但契合度的含义又和前面提到的满意程度看起来有冲突，所以需要进行仔细的评估（感觉是两个东西，一个是用户对作品在该标签的领域下表现力的满意度，一个是用户认为标签是否契合，后者好像更应该用是否关联该标签表达，但这种二分法失去了很多灰度）