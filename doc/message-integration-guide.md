...
面向后续要向前端用户展示消息的生产者：未来的后台操作（合并、翻译、AI 自动加标签、查重等）与任何消费后端事件的前端模块。两个系统于 2026-08 建成，设计依据见 `../library-squirrel-docs/plan/通知中心通用化方案.md` 与 `../library-squirrel-docs/plan/通用消息提醒系统设计方案.md`。
