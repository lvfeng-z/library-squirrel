...
// ==== 合并产物路径派生测试（与下载侧同口径：store/work/{桶段}/{作品目录}/videoMain_000.{ext}）====
...
func newMergeNamingService(work mergeNamingWork, site mergeNamingSite) *MergeService {
	return NewMergeService(nil, mergeNamingResource{}, work, site, nil, nil, nil, nil, nil, nil, nil, nil, nil)
}

// TestDeriveMergedPathsMatchesDownloadLayout 产物路径与文件名为派生形态（与下载侧
// store/work/{桶段}/{siteKey}_{siteWorkId}/{role}_{seq}.{ext} 同口径，桶段=复合键
