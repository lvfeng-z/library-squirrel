...
func NewSiteTagDTO(tag *entity2.SiteTag) *sdkdto.SiteTagDTO {
	if tag == nil {
		return nil
	}
	return &sdkdto.SiteTagDTO{
		ID:            tag.GetID(),
...
func ToSiteTagEntity(dto *sdkdto.SiteTagDTO) *entity2.SiteTag {
	if dto == nil {
		return nil
	}
...
type SiteTagFullDTO struct {
	SiteTag  *sdkdto.SiteTagDTO  `json:"siteTag,omitempty"`
...
func NewSiteTagFullDTO(siteTag *entity2.SiteTag) *sdkdto.SiteTagFullDTO {
	if siteTag == nil {
		return nil
	}
	dto := &sdkdto.SiteTagFullDTO{
		SiteTag: &sdkdto.SiteTagDTO{
			ID:            siteTag.GetID(),
...
func NewSiteTagLocalRelateDTO(siteTag *entity2.SiteTag) *sdkdto.SiteTagLocalRelateDTO {
	if siteTag == nil {
		return nil
	}
	return &sdkdto.SiteTagLocalRelateDTO{
