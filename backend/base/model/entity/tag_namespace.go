...
type TagNamespace struct {
	*model.BaseEntity
	...
	Value string `gorm:"column:value;uniqueIndex:idx_tag_namespace_value;not null" json:"value"`
...
func (TagNamespace) TableName() string {
	return "tag_namespace"
}

func NewTagNamespace() *TagNamespace {
	return &TagNamespace{
