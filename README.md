...
**Library Squirrel** 是一个基于标签的个人资源库管理工具：高效地把 Pixiv、Bilibili 等站点的作品下载并保存到你的本地资源库，不再担心喜欢的作品被删除，同时以「标签 / 作者 / 作品集」体系组织管理，并提供本地化的搜索与浏览体验，收集的再多也能快速找到。所有数据完全存储在本地，由你掌控。
