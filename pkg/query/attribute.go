...
func (a *QueryAttribute[any]) IsEmpty() bool {
	return a.Value == nil && a.Order == ""
}

// GetOperator 获取运算符，默认返回 eq
func (a *QueryAttribute[any]) GetOperator() Operator {
	if a.Operator == "" {
		return OpEq
	}
	return a.Operator
...
// HasOrder 判断是否需要排序
func (a *QueryAttribute[any]) HasOrder() bool {
	return a.Order != ""
}

// HasPriority 判断是否有排序优先级（Priority >= 0 表示有效）
func (a *QueryAttribute[any]) HasPriority() bool {
	return a.Priority >= 0
}
